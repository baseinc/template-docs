...
<!-- 注意: シンプルな構造にするため、sample.tplには一部の機能が含まれていません -->
<!--
 /$$$$$$$   /$$$$$$   /$$$$$$  /$$$$$$$$ 
| $$__  $$ /$$__  $$ /$$__  $$| $$_____/
| $$  \ $$| $$  \ $$| $$  \__/| $$      
                ...
                {block:ItemPage}
                    <div class="item">
                        <div class="item__mainImage">
                            {block:ItemImage1}
                            <img id="itemImage1" class="item__image" src="{ItemImage1URL-origin}">
                            {/block:ItemImage1}
                            {block:NoItemImage1}
                            <img id="itemImage1" class="item__image" src="{ItemNoImageURL}">
                            {/block:NoItemImage1}
                            {block:ItemImage2}
                            <img id="itemImage2" style="display:none;" class="item__image" src="{ItemImage2URL-origin}">
                            {/block:ItemImage2}
                            {block:ItemImage3}
                            <img id="itemImage3" style="display:none;" class="item__image" src="{ItemImage3URL-origin}">
                            {/block:ItemImage3}
                            {block:ItemImage4}
                            <img id="itemImage4" style="display:none;" class="item__image" src="{ItemImage4URL-origin}">
                            {/block:ItemImage4}
                            {block:ItemImage5}
                            <img id="itemImage5" style="display:none;" class="item__image" src="{ItemImage5URL-origin}">
                            {/block:ItemImage5}
                        </div>
                        <ul class="preview">
                          {block:ItemImage1}
                          <li class="preview__content" data-image-id="itemImage1">
                            <div class="item__subImage">
                              <img src="{ItemImage1URL-300}" alt="" title="">
                            </div>
                          </li>
                          {/block:ItemImage1}
                          {block:ItemImage2}
                          <li class="preview__content" data-image-id="itemImage2">
                            <div class="item__subImage">
                              <img src="{ItemImage2URL-300}" alt="" title="">
                            </div>
                          </li>
                          {/block:ItemImage2}
                          {block:ItemImage3}
                          <li class="preview__content" data-image-id="itemImage3">
                            <div class="item__subImage">
                              <img src="{ItemImage3URL-300}" alt="" title="">
                            </div>
                          </li>
                          {/block:ItemImage3}
                          {block:ItemImage4}
                          <li class="preview__content" data-image-id="itemImage4">
                            <div class="item__subImage">
                              <img src="{ItemImage4URL-300}" alt="" title="">
                            </div>
                          </li>
                          {/block:ItemImage4}
                          {block:ItemImage5}
                          <li class="preview__content" data-image-id="itemImage5">
                            <div class="item__subImage">
                              <img src="{ItemImage5URL-300}" alt="" title="">
                            </div>
                          </li>
                          {/block:ItemImage5}
                        </ul>
